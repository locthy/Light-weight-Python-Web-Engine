...
class HttpAdapter:
    ...
    def handle_client(self, conn, addr, routes):
        ...
        response = process_request(req, resp)
        """
        if req.hook:
            ...
            if req.method == "POST" and req.path == "/login":
                if req.body.get("username") == "admin" and req.body.get("password") == "password":
                    req.path = "/index.html"
                    resp.headers['Set-Cookie'] = 'auth=true; HttpOnly; Path=/'
                ...
                if req.path == "/" or req.path == "/index.html":
                    if req.cookies and req.cookies.get("auth") == "true":
                        ...
                        req.path = "/login.html"
                elif not req.cookies or req.cookies.get("auth") != "true":
                    req.path = "/login.html"
    ...
    def build_response(self, req, resp):
        ...
        response.cookies = req.prepare_cookies()
